...
SPORT_WORDS = [
  ...
  ("baseball",   ["야구","홈런","끝내기","만루","타자","투수","선발","안타","도루","kbo","mlb","npb",
                  ...
                  "ohtani","aaron judge","judge","trout","mookie","betts","juan soto","acuna","skenes",
                  "dodgers","yankees","astros","braves","world series"]),
  ("basketball", ["농구","덩크","버저","3점","자유투","리바운드","nba","kbl","euroleague",
                  "dunk","buzzer","basketball",
                  "lebron","stephen curry","curry","durant","jokic","doncic","giannis","wembanyama",
                  "tatum","embiid","lakers","warriors","celtics","nuggets","nba finals","playoffs"]),
  ...
  ("soccer",     ["축구","골","슈팅","프리킥","페널티","코너킥","epl","프리미어","라리가","분데스",
                  ...
                  "messi","ronaldo","mbappe","haaland","salah","bellingham","vinicius","kane",
                  "de bruyne","lewandowski","yamal","griezmann","neymar","real madrid","barcelona",
                  "man city","manchester","liverpool","arsenal","chelsea","tottenham","bayern","psg",
                  "juventus","champions league","clasico","derby"]),
]
...
# 해외 빅네임/빅클럽/빅매치 (영어 제목 허용 기준) — 축구·MLB·NBA
STAR_EN = ["messi","ronaldo","mbappe","haaland","salah","bellingham","vinicius","kane",
           "de bruyne","lewandowski","yamal","griezmann","neymar","real madrid","barcelona",
           "man city","manchester","liverpool","arsenal","chelsea","tottenham","bayern","psg",
           "juventus","champions league","clasico","derby",
           "ohtani","aaron judge","judge","trout","mookie","betts","juan soto","acuna","skenes",
